...
echo ""
echo "After that, every 'git clone' or 'git init' inside"
echo "\$CLAUDE_REPOS_ROOT (default: ~/GitHub/) will automatically create"
echo "a .claude/ scaffold. Set CLAUDE_REPOS_ROOT in your ~/.bashrc to"
echo "use a different directory."
